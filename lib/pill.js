  ...
  move(k) {
    if (this.active) {
      ...
      if (k === "right") {
        ...
        if (k === "z") {
          if (this.horizontal) {
            if (this.board[this.board1[0] - 1][this.board1[1]] === undefined) {
              this.board[this.board2[0]][this.board2[1]] = undefined;
              this.board2 = [this.board1[0] - 1, this.board1[1]];
              this.pos2 = [this.pos1[0], this.pos1[1] - 36];
              this.horizontal = false;
            }
          } else {
            if (this.board[this.board1[0]][this.board1[1] + 1] === undefined) {
              this.board[this.board2[0]][this.board2[1]] = undefined;
              this.board2 = [this.board1[0], this.board1[1] + 1];
              this.pos2 = [this.pos1[0] + 36, this.pos1[1]];
              const tempColor = this.color1;
